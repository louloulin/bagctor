import { BaseFilterTranslator } from '@bactor/agent/vector/filter';
import type { FieldCondition, VectorFilter, LogicalOperator, OperatorSupport } from '@bactor/agent/vector/filter';
